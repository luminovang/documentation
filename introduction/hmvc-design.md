...
* [PHP Attributes](/attributes/route.md) — for declarative, annotation-style route definitions.
* [Routing System Methods](/routing/system.md) — using the `Luminova\Routing\Router` for programmatic route registration.
...
#[Group(name: 'blog')]
class BlogController extends Command 
{
