# Base Cron Task Scheduling and Execution
...
* Class namespace: `Luminova\Foundation\core\CronTasks`
...
> **Note:** Your controller class must implement the `Luminova\Base\Command`, using other class will cause an error.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If invalid expression is provided.

---

### What Next?

* [Advanced Task Queue System](/base/task-queue.md)
  Learn about the task queue system, including scheduling, monitoring, and background processing.

* [Cron Tasks Configuration](/configs/cron-tasks.md)
  Read how to define cron tasks using static configuration files.

* [Running Cron Jobs with NovaKit](/task-queue-system/cron-task-execution.md)
  Understand how to execute and manage cron jobs through the CLI.