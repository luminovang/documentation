...
* Class Namespace: `Luminova\Time\Interval`
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - Throws if error occurs during execution.
...
```php
public static setInterval(callable $callback, int $milliseconds): Luminova\Time\Interval
```
