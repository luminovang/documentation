...
* Class namespace: `Luminova\Common\Escape`
...
Full supported list can be found [below](/utilities/input-escaper.md) in this documentation.
...
- [Luminova\Exceptions\InvalidArgumentException](/error-handlers/exceptions.md#invalidargumentexception) - Throws if unsupported encoding or empty string is provided.
...
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - When the called method does not exist.
...
`Luminova\Common\Escape` Return instance of escape class.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - When the string is not valid UTF-8 or cannot be converted.
