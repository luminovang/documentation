...
* Class namespace: `Luminova\Utility\Process`
...
```php
public __construct(
    \Psr\Http\Message\StreamInterface|Luminova\Utility\Storage\Stream|\Closure|resource|callable|array|string $input, 
    string $executor, 
    ?string $cwd = null, 
...
|-----------|------|-------------|
| `$input` | **\Psr\Http\Message\StreamInterface&#124;Luminova\Utility\Storage\Stream&#124;\Closure&#124;resource&#124;callable&#124;array&#124;string** | Command string, callable, or stream to be executed. |
...
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - Throws when attempt to serialize process.
...
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - Throws when attempt to unserialize process.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - Throws if the process fails to run or any error occurs.
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - If trying to called while the process is running.
- [Luminova\Exceptions\InvalidArgumentException](/error-handlers/exceptions.md#invalidargumentexception) - If an invalid command argument is specified.
...
```php
public static withStream(\Psr\Http\Message\StreamInterface|Luminova\Utility\Storage\Stream|resource $stream): self
```
...
| Parameter | Type | Description |
|-----------|------|-------------|
| `$stream` | **\Psr\Http\Message\StreamInterface&#124;Luminova\Utility\Storage\Stream&#124;resource** | The stream resource to read from. |
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - Throws if process is not started
...
- [Luminova\Exceptions\InvalidArgumentException](/error-handlers/exceptions.md#invalidargumentexception) - Throws if an error occurs.
...
**Throws:**
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - If trying to set working directory while the process is running.
...
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - If trying to set environment variables while the process is running.
...
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - If trying to set mode while the process is running.
...
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - If trying to set descriptors while the process is running.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If an invalid option is provided.
- [Luminova\Exceptions\BadMethodCallException](/error-handlers/exceptions.md#badmethodcallexception) - If trying to set options while the process is running.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If the process has not been started.