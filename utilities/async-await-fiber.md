...
* Class namespace: `Luminova\Utility\Async`
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If PHP Fiber is not supported on the system.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If PHP Fibers are not supported or the task does not complete in time.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - Throws if an error occurs during execution.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If the method is called while another task execution (`run` or `until`) is in progress.
