...
* Class namespace: `Luminova\Utility\Storage\FileManager`
...
- [Luminova\Exceptions\FileException](/error-handlers/exceptions.md#fileexception) - If permission is not granted and quiet is not passed true.
...
- [Luminova\Exceptions\FileException](/error-handlers/exceptions.md#fileexception) - If unable to write file or invalid resource.
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If path is not readable.
...
[Luminova\Exceptions\FileException](/error-handlers/exceptions.md#fileexception) - Throws If the path does not exist.
