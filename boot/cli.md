...
- [Base Command Classes](/controllers/cli-command-controller.md) - Learn how to extend and implement a CLI command controller class.
- [Routing Attributes](/attributes/route.md) - Learn about PHP attribute routing and its usage.