...
```php
public static language(?string $locale = null, bool $shared = true): Luminova\Component\Languages\Translator
```
...
```php
public static fileManager(bool $shared = true): Luminova\Utility\Storage\FileManager
```
