...
The **Base Configuration** class service as the foundation of your application's configuration classes, which are essential for the framework depending on the components utilized in your application. To create a new configuration class, you need to extend and define necessary properties and method as you need.

***

## Class Declaration

* Class namespace: `Luminova\Base\Configuration`
...
Bellow is an example how you can extend the `Configuration` class.
...
```php
final public static getEnv(string $key, mixed $default = null, ?string $return = null): mixed
```
