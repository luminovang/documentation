...
- [RuntimeException](/exceptions/runtime) - If search controller class is not installed.
...
- [RuntimeException](/exceptions/classes#RuntimeException) - If the search controller class is not installed.
