...
`Luminova\Foundation\Core\Application<\App\Application>` - Return application shared instance.
...
| `$shared` | **bool** | Whether to return shared instance (default: true). |
...
**Supported contexts:**
 ...
 -   `tor` - Return instance of `Luminova\Common\Tor`,
...
- [\Exception](/error-handlers/exceptions.md) - If an error occurs.
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If unable to call method.

**See Also**

[Core Functions](/foundation/functions.md) - Learn more about the Luminova's `CoreFunction` documentation.
...
| `$append_to_env` | **bool** | Whether to save or update the value in .env file (default: false). |
...
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If the library could not be found
...
- [Luminova\Exceptions\InvalidArgumentException](/error-handlers/exceptions.md#invalidargumentexception) - Throws if an error occurs while logging or an invalid destination is provided.
