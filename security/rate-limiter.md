...
```php
public __construct(
    Psr\Cache\CacheItemPoolInterface|Psr\SimpleCache\CacheInterface|Luminova\Base\Cache|Memcached|Predis\Client|Redis|null $cache = null, 
    int $limit = 10, 
...
```php
public setCache(
    Psr\Cache\CacheItemPoolInterface|Psr\SimpleCache\CacheInterface|Luminova\Base\Cache|Memcached|Predis\Client|Redis $cache
): self
```
...
- [Luminova\Exceptions\InvalidArgumentException](/error-handlers/exceptions.md#invalidargumentexception) - If the cache instance is invalid or the key is empty.
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If the cache is not connected.
...
- [Luminova\Exceptions\InvalidArgumentException](/error-handlers/exceptions.md#invalidargumentexception) - If the cache instance is not valid or the key is empty.
- [Luminova\Exceptions\RuntimeException](/error-handlers/exceptions.md#runtimeexception) - If cache is not connected.
