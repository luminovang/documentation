...
- [Luminova\Exceptions\DatabaseException](/error-handlers/exceptions.md#databaseexception) - If an invalid format is provided or if the export fails.
...
- [Luminova\Exceptions\DatabaseException](/error-handlers/exceptions.md#databaseexception) - If the backup fails or the directory cannot be created.